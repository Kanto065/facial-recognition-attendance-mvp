...
from app.utils.helpers import distance2bbox, distance2kps
...
class SCRFD:
    ...
    CPU-only ONNX Runtime inference, adapted from
    ...
    def detect(self, image: np.ndarray, max_num: int = 0, metric: str = "max") -> Tuple[np.ndarray, Optional[np.ndarray]]:
